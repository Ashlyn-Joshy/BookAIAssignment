  ...
  return (
    ...
    >
      ...
      <div className="border border-slate-400 rounded">
        <div className="m-3">
          <span className="p-2 border border-slate-400 rounded text-black dark:text-white">
      ...
      <button
        className="text-black dark:text-white rounded bg-blue-500 p-3 my-2 hover:bg-blue-900 hover:translate-y-1 transform transition-transform duration-300"
        onClick={generateKey}
      >
        Generate API Key
      </button>
